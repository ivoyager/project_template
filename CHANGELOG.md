...
Under development using Godot 4.2.beta6. _Has backward breaking changes!_

**NEW!** ivoyager_core editor plugin will download and add (or replace) assets for you. Just press 'Download' if prompted.

### Added
* ivoyager_tree_saver plugin (functionality moved out of ivoyager_core)
...
[v0.0.18]: https://github.com/ivoyager/project_template/compare/v0.0.17...HEAD
