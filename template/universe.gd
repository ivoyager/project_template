...
##
## [color=red]This root scene was duplicated and modified from [IVUniverseTemplate] in the
## Core plugin.[br][br]
##
## That class has the main simulator documentation, which is copied below...[/color]
## [br][br]
##
