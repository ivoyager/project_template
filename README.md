...
I, Voyager is free, open-source software built on the free, open-source [Godot Engine](https://godotengine.org). It is designed to be improved, modified and extended by the community. Follow the links below for more information:
...
Find more detailed instructions at our [Developers](https://www.ivoyager.dev/developers/) page.

To use this template, click the green "Use this template" button from the GitHub [repository page](https://github.com/ivoyager/project_template). GitHub will duplicate the template for you, prompting you to name your new project and set it to public or private.
